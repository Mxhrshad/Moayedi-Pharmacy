  ...
  return (
    ...
    >
      <iframe
        ...
        className="w-full md:w-1/2 h-80 md:h-96 border-teal-700 border-2 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300"
        allowFullScreen=""
        loading="lazy"
      ...
      <div className="w-full md:w-1/2 h-full flex flex-col justify-center items-center text-center mt-8 md:mt-0 md:pl-8">
        ...
        <p className="text-teal-200 mt-4 md:mt-6 text-base md:text-lg">رشت پل بوسار نرسیده به پل قلی پور ساختمان آماتیس</p>
        <motion.button 
